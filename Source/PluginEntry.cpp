...
extern "C" int UNITY_INTERFACE_EXPORT NDI_RetrieveSourceNames(const char* destination[], int maxCount,char* ip = nullptr)
{
	Finder::getInstance().tryResetIpAddress(ip);
